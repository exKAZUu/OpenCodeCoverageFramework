    ...
    public class Inserter {
        ...
        private static readonly string Usage =
                Program.Header +
                        ...
                        + "\n" + S + "".PadRight(W) + "in the given directories."
                        + "\n" +
                        S + "-i, -lib <path>".PadRight(W)
                        + "path of library directory where library files for "
                        + "\n" + S + "".PadRight(W) + "measuring coverage are copied."
                        + "\n" +
                        S + "-m, -mode <path>".PadRight(W)
                        + "recording mode of executed program elements: text, binary, shared"
                        + "\n" + S + "".PadRight(W) + "measuring coverage are copied."
                        + "\n" +
                        S + "<files>".PadRight(W)
                        + "file or directory paths to be inserted"
                        + "\n" + S + "".PadRight(W)
                        + "(root directory is used if no specified file)."
                        + "\n" +
                        "";
