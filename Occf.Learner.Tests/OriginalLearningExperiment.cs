...
namespace Occf.Learner.Core.Tests {
	public abstract class OriginalLearningExperiment {
		...
		protected OriginalLearningExperiment(params string[] elementNames) {
		...
		private Tuple<Dictionary<int, HashSet<Predicate>>, HashSet<SurroundingElementsPredicate>>
				CreatePredicates(
