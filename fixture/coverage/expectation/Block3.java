public class Block3 {
	public void method3 ( ) {
		int i= jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 22 , 0 , 2 ) ? ( 0 ) : ( 0 ) ;
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 0 , 0 , 2 ) ;
		if ( jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 12 , 3 , i == 0 ) ) {
			;
		}
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 1 , 0 , 2 ) ;
		while ( jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 13 , 3 , i != 0 ) ) {
			;
		}
		...
		while ( jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 14 , 3 , i != 0 ) ) ;
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 3 , 0 , 2 ) ;
		for ( i= 0 ;
		jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 18 , 3 , i< 0 ) ;
		i ++ ) {
			;
		}
		...
		if ( jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 15 , 3 , i == 0 ) ) {
		}
		...
		while ( jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 17 , 3 , i != 0 ) ) ;
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 9 , 0 , 2 ) ;
		for ( i= 0 ;
		jp . ac . waseda . cs . washi . CoverageWriter . WritePredicate ( 19 , 3 , i< 0 ) ;
		i ++ ) {
		}
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 10 , 0 , 2 ) ;
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 21 , 3 , 1 ) ;
		for ( int j : new int [ ] {
			1 , 2 }
		) {
			jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 21 , 3 , 0 ) ;
			jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 21 , 3 , 1 ) ;
		}
		jp . ac . waseda . cs . washi . CoverageWriter . WriteStatement ( 21 , 3 , 1 ) ;
